...
public class GamePanel extends JPanel implements ActionListener, KeyListener {
    ...
    private ImageIcon leftmouth = new ImageIcon(getClass().getResource("leftKmouth.png"));
    private ImageIcon rightmouth = new ImageIcon(getClass().getResource("rightKmouth.png"));
    private ImageIcon upmouth = new ImageIcon(getClass().getResource("upKmouth.png"));
    private ImageIcon downmouth = new ImageIcon(getClass().getResource("downKmouth.png"));
    private ImageIcon snakeimage = new ImageIcon(getClass().getResource("snakeimage.png"));
    private ImageIcon enemy = new ImageIcon(getClass().getResource("traitao003.png"));
